...
/**
 * Move/order course functionality for tb_in_courses block.
 *
...
list($courses, $sitecourses, $coursecount) = block_tb_in_courses_get_sorted_courses();
...
block_tb_in_courses_update_myorder(array_values($neworder));
redirect(new moodle_url('/my/index.php'));
